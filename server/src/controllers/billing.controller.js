...
export const getBillPdf = asyncHandler(async (req, res, next) => {
  ...
  // Load Settings to pull company variables
  ...
  // --- CLIENT DETAILS (Billing & Delivery Columns) ---
